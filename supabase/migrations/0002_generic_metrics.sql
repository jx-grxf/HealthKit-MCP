...
values
  ...
  ('body_fat_percentage','HKQuantityTypeIdentifierBodyFatPercentage','quantity','Body Fat Percentage','body','percent','avg','standard'),
  ...
  ('oxygen_saturation','HKQuantityTypeIdentifierOxygenSaturation','quantity','Blood Oxygen','vitals','percent','avg','standard'),
  ...
  ('blood_alcohol_content','HKQuantityTypeIdentifierBloodAlcoholContent','quantity','Blood Alcohol Content','lab','percent','avg','sensitive'),
  ('peripheral_perfusion_index','HKQuantityTypeIdentifierPeripheralPerfusionIndex','quantity','Peripheral Perfusion Index','vitals','percent','avg','standard'),
  ...
  ('walking_asymmetry_percentage','HKQuantityTypeIdentifierWalkingAsymmetryPercentage','quantity','Walking Asymmetry','mobility','percent','avg','standard'),
  ('walking_double_support_percentage','HKQuantityTypeIdentifierWalkingDoubleSupportPercentage','quantity','Double Support Time','mobility','percent','avg','standard'),
  ...
  ('apple_walking_steadiness','HKQuantityTypeIdentifierAppleWalkingSteadiness','quantity','Walking Steadiness','mobility','percent','avg','standard'),
  ...
  ('atrial_fibrillation_burden','HKQuantityTypeIdentifierAtrialFibrillationBurden','quantity','AFib History','heart','percent','avg','sensitive'),
  ...
  ('workout_effort_score','HKQuantityTypeIdentifierWorkoutEffortScore','quantity','Workout Effort Score','fitness','count','avg','standard'),
  ...
  ('estimated_workout_effort_score','HKQuantityTypeIdentifierEstimatedWorkoutEffortScore','quantity','Estimated Workout Effort','fitness','count','avg','standard'),
